        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="empty-state">
                    ...
                    <p class="lead">You haven't registered any tenants yet.</p>
                </div>
                @else
        ...
        <div
            ...
            <div class="bg-white rounded-lg shadow-xl w-100 mx-4"
                ...
                <div
                    ...
                    <h5 class="modal-title m-0">Add New Tenant</h5>
                ...
                <div class="modal-footer p-3 border-top sticky-bottom bg-white">
                    ...
                    <button wire:click="createTenant" class="btn btn-primary">Save</button>
                </div>
            </div>
        </div>
    </div>
