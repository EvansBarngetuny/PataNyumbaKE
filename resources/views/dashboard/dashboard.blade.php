        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                ...
                <ul class="collapse list-unstyled ps-3" id="propertiesMenu">
                    <li><a class="nav-link" href="#">Post A room</a></li>
                    <li><a class="nav-link" href="{{ route('layouts.allListings') }}">All Properties</a></li>
                    <li><a class="nav-link" href="#">Pending Approvals</a></li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var options = {
            ...
            yaxis: {
                title: { text: 'Amount', style: { fontSize: '12px', color: '#333' } },
                labels: { formatter: value => 'Ksh ' + value.toLocaleString() }
            },
